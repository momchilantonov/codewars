def number(bus_stops):
    ...
    for bus_stop in bus_stops:
        getting_on += bus_stop[0]
        getting_off += bus_stop[1]

    return getting_on - getting_off


# TESTS
assert number([[10,0],[3,5],[5,8]]) == 5, 'Try again bro!'
assert number([[3,0],[9,1],[4,10],[12,2],[6,1],[7,10]]) == 17, 'Try again bro!'
assert number([[3,0],[9,1],[4,8],[12,2],[6,1],[7,8]]) == 21, 'Try again bro!'
